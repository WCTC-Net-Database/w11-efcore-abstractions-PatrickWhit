...
namespace ConsoleRpgEntities.Migrations
{
    ...
    [Migration("20251113235523_AttackLogic")]
    partial class AttackLogic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipables_Items.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipment.Equipable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipables_Items.Armor", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Equipables_Items.Item");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipables_Items.Weapon", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Equipables_Items.Item");
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Player", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Equipment.Equipable", "Equipment")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Equipment.Equipable", b =>
                {
                    b.HasOne("ConsoleRpgEntities.Models.Equipables_Items.Armor", "Armor")
                        .WithMany()
                        .HasForeignKey("ArmorId");

                    b.HasOne("ConsoleRpgEntities.Models.Equipables_Items.Weapon", "Weapon")
                        .WithMany()
            ...
            modelBuilder.Entity("ItemPlayer", b =>
                {
                    ...
                    b.HasOne("ConsoleRpgEntities.Models.Equipables_Items.Item", null)
                        .WithMany()
